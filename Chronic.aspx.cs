...
public partial class Default6 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        str = "select imageS,Name from Skin1 where Name='Eczema' ";
        ...
        str1 = "select imageS,Name from Skin1 where Name='Scleroderma' ";
        ...
        str2 = "select imageS,Name from Skin1 where Name='Psoriasis' ";
    ...
    protected void _onclick(object sender, ImageClickEventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(strConnString);
        con.Open();
        str = "select Name,Symptoms,Symptoms1,Cause,Treatment,Treatment1,Treatment2,Extra from Skin1 where Name='Eczema' ";
        com = new SqlCommand(str, con);
        SqlDataReader reader = com.ExecuteReader();
    ...
    protected void a_onclick(object sender, ImageClickEventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(strConnString);
        con.Open();
        str = "select Name,Symptoms,Symptoms1,Cause,Treatment,Treatment1,Treatment2,Extra from Skin1 where Name='Scleroderma' ";
        com = new SqlCommand(str, con);
        SqlDataReader reader = com.ExecuteReader();
    ...
    protected void b_onclick(object sender, ImageClickEventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(strConnString);
        con.Open();
        str = "select Name,Symptoms,Symptoms1,Cause,Treatment,Treatment1,Treatment2,Extra from Skin1 where Name='Psoriasis' ";
        com = new SqlCommand(str, con);
        SqlDataReader reader = com.ExecuteReader();
