<%@ Page Language="C#" AutoEventWireup="true" CodeFile="apage.aspx.cs" Inherits="Default6" %>
    ...
    <div>
                    ...
                    <li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <ul class="dropdown-menu extended logout">
                            <div class="log-arrow-up">
                             ...
                             <li class="eborder-top"><a href="apage.aspx"><i class="icon_profile"></i>Admin Page</a>
                            </li>
      ...
      <!--sidebar start-->
            ...
            <div id="sidebar"  class="nav-collapse ">
              <!-- sidebar menu start-->
                <ul class="sidebar-menu">
                    <li class="active"><a class="" href="apage.aspx"><i class="icon_house_alt"></i>
                        <span>Home</span> </a></li>
          ...
          <section class="wrapper">
              <!--overview start-->
			  <div class="col-md-6 portlets"><div style="  background: radial-gradient(circle, white, green);">
                 <br />
                  <asp:Button ID="Button8" CssClass="btn-success" runat="server" onclick="Button8_Click" 
                      Text="view user" Width="300px" />
                  <br />
                  <br />
                 <asp:Button ID="Button1" CssClass="btn-success" runat="server" Text="Manage users" 
        onclick="Button1_Click" Width="300px" />
    <br />
    <br />
    <asp:Button ID="Button2" runat="server" CssClass="btn-success" onclick="Button2_Click" 
    Text="Manage Doctors" Width="300px" />
    <br />
    <br />
    <asp:Button ID="Button7" runat="server" CssClass="btn-success" onclick="Button7_Click" 
        Text="Add skin disease" Width="300px" />
    <br />
    <br />
    <asp:Button ID="Button3" runat="server" CssClass="btn-success" Text="Manage skin disease" 
        onclick="Button3_Click" Width="300px"  />
    <br />
    <br />
    <asp:Button ID="Button6" CssClass="btn-success" runat="server" Text="Manage exercises" 
        onclick="Button6_Click" Width="300px" />
    <br />
    <br />
    <asp:Button ID="Button4" CssClass="btn-success" runat="server" Text="Appointments" 
        onclick="Button4_Click" Width="300px" />
    <br />
    <br />
    <asp:Button ID="Button5" CssClass="btn-success" runat="server" Text="Feedbacks" 
        onclick="Button5_Click" Width="300px" />
                  <br />
                  <br />
                   <asp:Button ID="Button9" CssClass="btn-success" runat="server" Text="Blogs" 
        onclick="Button9_Click" Width="300px" />
                  <br />
