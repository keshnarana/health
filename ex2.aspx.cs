...
public partial class Default6 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        str = "select * from Exercise where name='V-Pull Plié' ";
        ...
        str1 = "select * from Exercise where name='Capoeira Skater' ";
        ...
        str2 = "select * from Exercise where name='Criss-Cross Squat Jacks' ";
        ...
        str3 = "select * from Exercise where name='Plank Leg Sweep' ";
