    ...
    <div class="mobile-nav">
		...
		<div class="modal-dialog">
			<div class="modal-content modal-popup">
				...
				<h1 class="white" style="text-align:center">Login</h1><br />
				<form action="" class="popup-form">
                           <table style="width:300px; height:200px;">    
                            <tr>
                                    <td style="width:100px; height:50px; color:White; font-size:x-large"  >
                                        Name: 
                                    </td>
                                    <td class="style5" >
                                        <asp:Textbox type="text" class="form-control form-white"  ID="TextBox1" runat="server" Width="300px" Height="12px" />
                                    </td>
                                    <td style="width:100px; height:50px; font-size:larger" >
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1"
                                            ErrorMessage="*enter name" ForeColor="Blue"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:100px; height:50px; color:White; font-size:x-large"  >
                                    ...
                                    <td class="style5" >
                                        <asp:Textbox type="text" class="form-control form-white" ID="TextBox2"  
                                            runat="server"  TextMode="Password"  Width="300px" Height="12px" />
                                    </td>
                                    <td style="width:100px; height:50px; font-size:larger">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2"
                                            ErrorMessage="*pasword please " ForeColor="Blue"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                           </table><a href="forgotp.aspx">forgot password</a>
			...
			<div class="row intro-tables">
				...
				<div class="col-md-4">
					<div class="intro-table intro-table-hover">
						...
						<div class="bottom">
							<h4 style="text-align:center; color:White">Register Today</h4>
							<h4 style="text-align:center; color:White"></h4>
							<a href="r.aspx" class="btn btn-white-fill expand">Register</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="intro-table intro-table-third"><br />
					<h5 style="text-align:center; color:White; top: 130px; left: 0px;"> We help you can check how healthy or fit you are with just few clicks.</h5>
						<h5 style="text-align:center; color:White"> Stay healthy. Stay fit.</h5><br />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<br /><br />
