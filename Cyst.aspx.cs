...
public partial class Default6 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        str = "select imageS,Name from Skin1 where Name='Keratosis Pilaris' ";
        ...
        reader.Close();
        str1 = "select imageS,Name from Skin1 where Name='Keloids' ";
        ...
        reader1.Close();
        str2 = "select imageS,Name from Skin1 where Name='Abscess' ";
    ...
    protected void _onclick(object sender, ImageClickEventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(strConnString);
        con.Open();
        str = "select Name,Symptoms,Symptoms1,Cause,Treatment,Treatment1,Treatment2,Extra from Skin1 where Name='Keratosis Pilaris' ";
        com = new SqlCommand(str, con);
        SqlDataReader reader = com.ExecuteReader();
        reader.Read();
    ...
    protected void b_onclick(object sender, ImageClickEventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(strConnString);
        con.Open();
        str = "select Name,Symptoms,Symptoms1,Cause,Treatment,Treatment1,Treatment2,Extra from Skin1 where Name='Abscess' ";
        com = new SqlCommand(str, con);
        SqlDataReader reader = com.ExecuteReader();
        reader.Read();
        labelname1.Text = reader["Symptoms"].ToString();
    ...
    protected void a_onclick(object sender, ImageClickEventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(strConnString);
        con.Open();
        str = "select Name,Symptoms,Symptoms1,Cause,Treatment,Treatment1,Treatment2,Extra from Skin1 where Name='Keloids' ";
        com = new SqlCommand(str, con);
        SqlDataReader reader = com.ExecuteReader();
        reader.Read();
        labelname1.Text = reader["Symptoms"].ToString();
